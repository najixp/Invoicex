...
public class NewEstimateActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
                ...
                (Request.Method.POST, Network.API_URL + "clients/get", api_parameter, response -> {
                    try {
                        ...
                        if (clients.length() > 0) {
                            ...
                            ArrayAdapter<String> adapter = new ArrayAdapter<>(NewEstimateActivity.this, R.layout.custom_simple_spinner_item, array_clients);
    ...
    private void generateLayout(Document doc, PdfContentByte cb)  {
        ...
        try {
            ...
            createText(cb, 40, line_heading_start, "#", SIZE_TEXT_HEADER_TABLE, bf, BaseColor.WHITE, Element.ALIGN_LEFT);
            createText(cb, 70, line_heading_start, getResources().getString(R.string.item), SIZE_TEXT_HEADER_TABLE, bf, BaseColor.WHITE, Element.ALIGN_LEFT);
            createText(cb, 400, line_heading_start, getResources().getString(R.string.rate), SIZE_TEXT_HEADER_TABLE, bf, BaseColor.WHITE, Element.ALIGN_RIGHT);
            createText(cb, 460, line_heading_start, getResources().getString(R.string.quantity), SIZE_TEXT_HEADER_TABLE, bf, BaseColor.WHITE, Element.ALIGN_RIGHT);
            createText(cb, 568, line_heading_start, getResources().getString(R.string.amount), SIZE_TEXT_HEADER_TABLE, bf, BaseColor.WHITE, Element.ALIGN_RIGHT);
        }
        catch (Exception ex){
            ex.printStackTrace();
        }
    ...
    private void generateDetail(Document doc, PdfContentByte cb, int index, int y)  {
        ...
        try {
            ...
            createText(cb, 400, y, helper_number.round(item.Rate), SIZE_TEXT_NORMAL, bf, BaseColor.BLACK, Element.ALIGN_RIGHT);
